...
export function ChecklistProvider({ children }) {
  ...
  // Add all functions to the provider value
  const value = {
    ...checklistData,
    ...
    disableTask: checklistData.disableTask,
    saveTask: checklistData.saveTask,
    getSavedTasks: checklistData.getSavedTasks,
    deleteSavedTask: checklistData.deleteSavedTask,
  };
